...
class CLIPVisionTower(nn.Module):
    ...
    def load_model(self, device_map=None):
        ...
        config = CLIPConfig.from_pretrained(self.vision_tower_name)
        self.vision_tower = CLIPVisionModel.from_pretrained(self.vision_tower_name, config=config.vision_config, device_map=device_map)

        # self.vision_tower = CLIPVisionModel.from_pretrained(self.vision_tower_name, device_map=device_map, ignore_mismatched_sizes=True)
